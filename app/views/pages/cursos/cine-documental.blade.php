...
@section('content')
  ...
  <h2>LA MEMORIA. HISTORIA DEL DOCUMENTAL</h2>
   <strong><p>Curso de análisis cinematográfico impartido por: Laura Martínez Díaz</p>
    ...
    <p>Uno de los objetivos del curso LA MEMORIA. HISTORIA DEL DOCUMENTAL, es hacer un recorrido cronológico del documental desde sus inicios. Paralelamente conoceremos algunos de los distintos géneros que se han desarrollado, desde los primeros de contenido antropológico, hasta algunos recientes de gran éxito en taquilla. Para ello, serán proyectados doce de los documentales más representativos, con el objetivo último de comprender la importancia del documental como un vehículo para reconstruir, recuperar y preservar la memoria.</p>

    <p><strong>Sesión 1</strong></p>
    <p>"Cortos de los Hnos. Lumiére (1895) Grabación de Porfirio Díaz en Chapultepec por un grupo de camarógrafos de los Hnos. Lumiére</p>
    <p><strong>Sesión 2</strong></p>
    <p>"Nanook el esquimal" de Robert Flaherty (1922)</p>
    <p><strong>Sesión 3</strong></p>
    <p>"El hombre de la cámara" de Dziga Vertov (1929)</p>
    <p><strong>Sesión 4</strong></p>
    <p>"Drifters" ("Pescadores a la deriva")  de John Grierson  (1929)</p>
    <p><strong>Sesion 5</strong></p>
    <p>"Las Hurdes. Tierra sin pan", de Luis Buñuel (1932)</p>
    <p><strong>Sesión 6</strong></p>
    <p>"Misère au Borinage"  de Joris Ivens (933)</p>
    <p><strong>Sesión 7</strong></p>
    <p>"Noche y niebla" de Alain Resnais (1955)</p>
    <p><strong>Sesión 8</strong></p>
    <p>"Lettre de Sibérie" de Chris Marker (1958)</p>
    <p><strong>Sesión 9</strong></p>
    <p>"Crónica de un verano" de Edgar Morin y Jean Rouch (1961)</p>
    <p><strong>Sesión 10</strong></p>
    <p>"Titicut Follies" de Fred Wiseman (1967)</p>
    <p><strong>Sesión 11</strong></p>
    <p>Documentales con gran éxito comercial "Mondo cane" de Paolo Cavara, Gualterio Jacopetti y Franco E. Prospe (1962)</p>
    <p><strong>Sesión 12</strong></p>
    <p>Documental hecho en animación "Vals con Bachir"</p>
    <br><br>
