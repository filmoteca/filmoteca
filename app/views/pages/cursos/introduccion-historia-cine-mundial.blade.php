...
@section('content')
  ...
  <h6>TEMARIO</h6>
    ...
    <p>I. Antecedentes e inicios de la fotografía en movimiento y sus aportaciones, de 1825 a 1895.</p>
      <ul>
        <li>Surgimiento del cinematógrafo con Edison, los hermanos Lumiere y Mellies, innovador en los efectos visuales y el cine a "color".
        </li>
      </ul>
    <p>II. David W. Griffith, creador del lenguaje cinematográfico.</p>
      <ul>
        <li>El <em>western</em>, legado del cine norteamericano.</li>
        <li>La comedia como género y sus máximos exponentes.</li>
      </ul>
    <p>III. Etapa del cine silente.</p>
      <ul>
        <li>El cine llega a México adoptando identidad nacionalista; comedia ranchera, Época de oro y ambiente de arrabal.</li>
      </ul>
    <p>IV. El sonoro-parlante.</p>
      <ul>
        <li>El cine como industria y los grandes estudios.</li>
        <li>Cine negro y de <em>gangsters.</em></li>
      </ul>
    <p>V. Principales escuelas (1a parte):</p>
      <ul>
        <li>Expresionismo alemán.</li>
        <li>Surrealismo español.</li>
        <li>Propaganda soviética.</li>
        <li>Neorrealismo italiano.</li>
      </ul>
    <p>VI. Principales escuelas (2a parte):</p>
      <ul>
        <li><em>Nouvelle vague.</em></li>
        <li>Regionalismo japonés.</li>
        <li>Musicales de Hollywood.</li>
        <li><em>Free</em> cinema británico.</li> 
      </ul>
    <p>VII. Orígenes de la animación.</p>
      <ul>
        <li>Ficción de aventura, ciencia-ficción y horror.</li>
        <li>Política, religión, literatura y rock en el cine.</li>
      </ul> 
    <p>VIII. Cine bélico, luchas revolucionarias, guerra civil española, guerra mundial y la dictadura sudamericana como argumento.</p>
    <p>IX.<em> Star system</em>, academias cinematográficas y festivales.</p> 
    <p>X. Grandes directores y cine de autor (1a parte).</p> 
    <p>XI. Grandes directores y cine de autor (2a parte).</p> 
    <p>XII. Revisión del cine contemporáneo.</p>
    <br><br>
