...
<div class="content">
	...
	<h2>Bibliotecología y estudios de la información:</h2>
	<ul>
	...
	<h2>Literatura dramática y teatro:</h2>
	<ul>
	...
	<h2>Comunicación y periodismo:</h2>
	<ul>
		...
		<h2>Diseño y comunicación visual:</h2>
		<ul>
		...
		<h2>Desarrollo y gestión interculturales:</h2>
		<ul>
			...
			<p>Si deseas ser parte del programa de Servicio Social de la Filmoteca de la UNAM debes contar con un 70% de créditos cubiertos, historial académico que ratifique la información e identificación oficial. Comunicarte con la maestra Nadina Illescas Villegas al teléfono 5622-9589 y 5622-9595, o al correo electrónico nadina1020@gmail.com para pedir una cita o ampliar la información.</p>
</div>
@stop