		...
		<div class="flm-section flm-subsection digital-billboard">
            <div class="content">
                <div class="image pull-left">
                    <img src="/imgs/home/cartelera/cartelera-home-octubre2015.jpg">
                </div>
                <div class="caption pull-right">
                    <a href="http://issuu.com/filmotecaunam/docs/carteleradigitaloct2015" title="Consulta la cartelera digital" alt="Consulta la cartelera digital"target="_blank">Consulta<span class="icon icon-download pull-right"></span></a>
                </div>   
                <div class="caption pull-right">
                    <a href="/pdf/cartelera/CarteleraDigitalOct2015.pdf" title="Descarga la cartelera digital" alt="Descarga la cartelera digital" target="_blank">Descarga<span class="icon icon-download pull-right"></span></a>
                </div>
            </div>
        </div>
