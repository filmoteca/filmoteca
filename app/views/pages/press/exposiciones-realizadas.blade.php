    ...
    <h2>EXPOSICIONES REALIZADAS</h2>
           ...
           <div class="row">
            ...
            <div class="col-6 col-sm-6 col-lg-6">
              ...
              <p><a class="btn btn-default" href="http://filmoteca.dev/pdf/exposiciones/cine_y_revolucion.pdf" target="_blank" role="button">Leer más »</a></p>
            </div><!--/span-->
            ...
            <div class="col-6 col-sm-6 col-lg-6">
              ...
              <p><a class="btn btn-default" href="http://filmoteca.dev/pdf/exposiciones/magnum_fotos.pdf" target="_blank" role="button">Leer más »</a></p>
            </div><!--/span-->
