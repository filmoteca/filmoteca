...
{{ Form::model( 
	$resource,
	[
		'route' => ['admin.student.update', $resource->id], 
		'files' => true,
		'method'=> 'PUT',
	...
	<div class="form-group">
		<label class="col-sm-2 control-label text-right" for="unam_member">Perteneciente a la UNAM</label>{{ Form::checkbox('unam_member') }}
		</p>
	</div>	
	<div class="form-group">
