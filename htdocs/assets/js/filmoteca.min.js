...
$(document).ready(function () {
    ...
    $exhibitionsIndex.on('click', moreSchedulesSelector , function (event) {
        ...
        //if ($element.data('loaded')) {
           // $collapsible.collapse('toggle'); //esta función hace que el botón se pueda apretar una y otra vez
            // return;
        //}
    ...
    $('.more-schedules').trigger('click'); //se agrego un disparador para cargar más horarios por default
    $('.more-schedules').addClass('loading');  //se cambió de lugar 
...
$(document).ready(function () {
    ...
    $( '#winner-searcher' ).autocomplete({
        ...
        return $('<li>')
            .append(
                '<div><img class="tiny-searchresults" src="' +item.url_image + '">' + item.name + '<br>' + item.award_date + '</div>'
            )
            .appendTo(ul);
    };
});
